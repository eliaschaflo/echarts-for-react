...
export default class EChartsReactCore extends PureComponent<EChartsReactProps> {
  ...
  private updateEChartsOption(): EChartsInstance {
    const { option, notMerge = false, replaceMerge, lazyUpdate = false, showLoading, loadingOption = null } = this.props;
    const opts = { notMerge:notMerge, replaceMerge:replaceMerge, lazyUpdate:lazyUpdate }
